...
export default function OptimiseTablePage() {
  ...
  // Apply filters to corridor and non-corridor requests
  const corridorRequestsFiltered = pendingRequests
    .filter((r: UserRequest) => {
                        ...
                        {request.optimizeStatus === false ? (
                          ...
                          <>
                            <button
                              ...
                              style={{ backgroundColor: "#f0b100", color: "white" }}
                            ...
                            <button
                              ...
                              style={{ backgroundColor: "#f69697", color: "white" }}
                            ...
                            <button
                              ...
                              style={{ backgroundColor: "#d1d5dc", color: "white" }}
