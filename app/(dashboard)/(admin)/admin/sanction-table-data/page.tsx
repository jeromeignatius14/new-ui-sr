...
//     []
//   );
//   const [activeFilter, setActiveFilter] = useState<"approved" | "granted" | "availed" |"all">("all");
...
//                   <th className="border-2 border-black px-4 py-2">Demanded (in Hrs) / No. of Blocks</th>
//                   <th className="border-2 border-black px-4 py-2">Approved (in Hrs) / No. of Blocks</th>
        ...
        <div className="w-full px-2 md:px-4 flex flex-col items-center justify-center mt-4 md:mt-8 mb-4 space-y-3 md:space-y-4">
          ...
          <div className="flex items-center gap-2 bg-[#cfd4ff] px-3 md:px-4 py-2 rounded-2xl border-2 max-w-full">
            <span className="text-[14px] md:text-[24px] font-bold text-black text-center">
              Click <span className="bg-[#00b347] text-white font-bold px-1 md:px-2 py-1 rounded text-[14px] md:text-[24px] mx-1">DivisionId</span> to see further details.
            </span>
          </div>
