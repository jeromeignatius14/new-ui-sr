...
const DEPARTMENTS = [
    ...
    { value: "ENGG", label: "Engineering (ENGG)" },
    { value: "S&T",  label: "S&T" },
    { value: "TRD",  label: "TRD" },
];
...
export default function DrmDefaultersPage() {
    ...
    function applyFilter() {
        setApplied({ startDate, endDate, department: deptSelect });
    }

    const deptLabel = DEPARTMENTS.find((d) => d.value === applied.department)?.label ?? "All Departments";
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
            ...
            <div className="px-4 py-5 max-w-screen-xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-md border border-gray-300 p-5 mb-6">
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Filter</p>
                    <div className="flex flex-wrap gap-4 items-end">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <select
                                ...
                                className="border-2 border-gray-400 bg-gray-50 hover:border-indigo-400 focus:border-indigo-600 focus:bg-white rounded-lg px-4 py-2.5 text-sm font-medium text-gray-800 focus:outline-none transition shadow-sm min-w-[200px]"
                            >
                                {DEPARTMENTS.map((d) => (
