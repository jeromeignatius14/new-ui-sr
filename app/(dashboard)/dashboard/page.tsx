    ...
    return (
      <div className="min-h-screen w-full flex flex-col items-center bg-[#fffbe9]">
        ...
        <div className="w-full flex flex-col items-center gap-5 mt-6 px-2 max-w-md">
          ...
          <a href={`https://e4f2cddc6870.ngrok-free.app/?cugNumber=${session?.user?.phone}&token=W1IU66ZFEBFBF6C1dGmouN6PVyHARQJg`} className="w-full rounded-full bg-[#a6f7a6] border border-black py-6 text-xl font-extrabold text-black text-center shadow hover:scale-105 transition">AVAIL BLOCK AT SITE</a>
