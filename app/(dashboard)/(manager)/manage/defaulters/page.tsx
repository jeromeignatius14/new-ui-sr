    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 md:p-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 mb-6 flex flex-wrap gap-4 items-end shadow-sm">
                <div>
                    <label className="block text-xs font-semibold text-gray-500 uppercase mb-1">Demanded Working Date — From</label>
                    <input
                        type="date"
                        value={startDate}
                ...
                <div>
                    <label className="block text-xs font-semibold text-gray-500 uppercase mb-1">Demanded Working Date — To</label>
                    <input
                        type="date"
                        value={endDate}
